"""Test dgs/qed_feynman_diagrams.py: the wavy-line squiggle actually lands on
...
import numpy as np
from dgs.qed_feynman_diagrams import (
...
print("all dgs.qed_feynman_diagrams tests passed")
