...
class PstNode(Node):  # type: ignore[misc]
    ...
    def __init__(self) -> None:
        ...
        self.get_logger().info(f"PhyCV PST node: {input_topic} -> {output_topic}")

    def _params(self) -> PstParams:
        return PstParams(
    ...
    def _on_image(self, msg: "Image") -> None:
        ...
        edges = phase_stretch_transform(gray, self._params()).edges.astype(np.float64)
